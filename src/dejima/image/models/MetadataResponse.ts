...
export function MetadataResponseFromJSONTyped(
  json: any,
...
export function MetadataResponseToJSON(value?: MetadataResponse | null): any {
  if (value === undefined) {
    return undefined;
  }
  if (value === null) {
