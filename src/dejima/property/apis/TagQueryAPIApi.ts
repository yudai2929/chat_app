...
import {
  ...
  TagListResult,
  TagListResultFromJSON,
  TagListResultToJSON,
} from '../models';

export interface ListTagRequest {
  category: ListTagCategoryEnum;
  startIndex?: number;
  itemsPerPage?: number;
}
 ...
 * no description
 */
export class TagQueryAPIApi extends runtime.BaseAPI {
  /**
   * List Tag
   */
  async listTagRaw(
    requestParameters: ListTagRequest
  ): Promise<runtime.ApiResponse<TagListResult>> {
    if (
      ...
      throw new runtime.RequiredError(
        'category',
        'Required parameter requestParameters.category was null or undefined when calling listTag.'
      );
    }
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      TagListResultFromJSON(jsonValue)
    );
  }
   ...
   * List Tag
   */
  async listTag(requestParameters: ListTagRequest): Promise<TagListResult> {
 ...
 * @enum {string}
 */
export enum ListTagCategoryEnum {
  Property = 'property',
  Building = 'building',
}
