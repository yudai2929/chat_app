...
export interface RenewalFee {
   ...
   * @memberof RenewalFee
   */
  readonly renewalFeeClass?: string;
  /**
   * 1: 新賃料<br/>2: 旧賃料
   * @type {number}
   * @memberof RenewalFee
   */
  renewalFeeClassCode?: number;
}

export function RenewalFeeFromJSON(json: any): RenewalFee {
  return RenewalFeeFromJSONTyped(json, false);
}

export function RenewalFeeFromJSONTyped(
  json: any,
  ...
  return {
    ...
    renewalFeeClass: !exists(json, 'renewal_fee_class')
      ? undefined
      : json['renewal_fee_class'],
    renewalFeeClassCode: !exists(json, 'renewal_fee_class_code')
      ? undefined
      : json['renewal_fee_class_code'],
  };
}

export function RenewalFeeToJSON(value?: RenewalFee | null): any {
  if (value === undefined) {
    return undefined;
  }
  if (value === null) {
  ...
  return {
    ...
    unit: value.unit,
    renewal_fee_class_code: value.renewalFeeClassCode,
  };
}
