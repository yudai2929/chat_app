 ...
 * 駅・沿線別集計小計
 * @export
 * @interface LineAggregateElem
 */
export interface LineAggregateElem {
  /**
   * 物件数
   * @type {number}
   * @memberof LineAggregateElem
   */
  count: number;
  /**
   * ドリルダウン用クエリパラメータ
...
export function LineAggregateElemFromJSON(json: any): LineAggregateElem {
  return LineAggregateElemFromJSONTyped(json, false);
}

export function LineAggregateElemFromJSONTyped(
  json: any,
  ...
  return {
    ...
    parentName: !exists(json, 'parent_name') ? undefined : json['parent_name'],
  };
}

export function LineAggregateElemToJSON(value?: LineAggregateElem | null): any {
  if (value === undefined) {
    return undefined;
  }
  if (value === null) {
