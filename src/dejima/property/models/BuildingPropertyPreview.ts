...
import {
  ...
  RentPropertyPreviewBaseFromJSON,
  RentPropertyPreviewBaseFromJSONTyped,
  RentPropertyPreviewBaseToJSON,
} from './';

/**
 * 賃貸物件概要（建物棟別表示）
 * @export
 * @interface BuildingPropertyPreview
 */
export interface BuildingPropertyPreview {
  /**
   *
   * @type {string}
   * @memberof BuildingPropertyPreview
   */
  ...
  /**
   *
   * @type {Array<RentPropertyPreviewBase>}
   * @memberof BuildingPropertyPreview
   */
  property?: Array<RentPropertyPreviewBase>;
}

export function BuildingPropertyPreviewFromJSON(
  json: any
): BuildingPropertyPreview {
  return BuildingPropertyPreviewFromJSONTyped(json, false);
}

export function BuildingPropertyPreviewFromJSONTyped(
  json: any,
  ...
  return {
    ...
    propertyTotalCounts: json['property_total_counts'],
    property: !exists(json, 'property')
      ? undefined
      : (json['property'] as Array<any>).map(RentPropertyPreviewBaseFromJSON),
  };
}

export function BuildingPropertyPreviewToJSON(
  value?: BuildingPropertyPreview | null
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    property_total_counts: value.propertyTotalCounts,
    property:
      value.property === undefined
        ? undefined
        : (value.property as Array<any>).map(RentPropertyPreviewBaseToJSON),
  };
}
