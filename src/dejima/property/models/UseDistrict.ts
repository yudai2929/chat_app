 ...
 * 用途地域
 * @export
 * @interface UseDistrict
 */
export interface UseDistrict {
  /**
   *
   * @type {string}
   * @memberof UseDistrict
   */
  readonly useDistrict?: string;
  /**
...
export function UseDistrictFromJSON(json: any): UseDistrict {
  return UseDistrictFromJSONTyped(json, false);
}

export function UseDistrictFromJSONTyped(
  json: any,
  ...
  return {
    useDistrict: !exists(json, 'use_district')
      ? undefined
      : json['use_district'],
    useDistrictCode: !exists(json, 'use_district_code')
      ? undefined
      : json['use_district_code'],
...
export function UseDistrictToJSON(value?: UseDistrict | null): any {
  if (value === undefined) {
    return undefined;
  }
  if (value === null) {
  ...
  return {
    use_district_code: value.useDistrictCode,
