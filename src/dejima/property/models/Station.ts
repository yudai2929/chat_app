...
export function StationFromJSONTyped(
  json: any,
  ...
  return {
    stationCode: !exists(json, 'station_code')
      ? undefined
      : json['station_code'],
    stationName: !exists(json, 'station_name')
      ? undefined
      : json['station_name'],
    lineCode: !exists(json, 'line_code') ? undefined : json['line_code'],
    lineName: !exists(json, 'line_name') ? undefined : json['line_name'],
