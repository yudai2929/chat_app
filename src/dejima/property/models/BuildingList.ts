...
export interface BuildingList {
  ...
  /**
   * 建物概要
   * @type {Array<BuildingPreview>}
   * @memberof BuildingList
   */
  results: Array<BuildingPreview>;
}

export function BuildingListFromJSON(json: any): BuildingList {
  return BuildingListFromJSONTyped(json, false);
}

export function BuildingListFromJSONTyped(
  json: any,
  ...
  return {
    ...
    results: (json['results'] as Array<any>).map(BuildingPreviewFromJSON),
  };
}

export function BuildingListToJSON(value?: BuildingList | null): any {
  if (value === undefined) {
    return undefined;
  }
  if (value === null) {
  ...
  return {
    ...
    results: (value.results as Array<any>).map(BuildingPreviewToJSON),
  };
}
