...
/**
 * 掲載先<br/>103: EsB2B<br/>105: ウェブサイト
 * @export
 * @enum {string}
 */
export enum RentBaitaiCode {
  NUMBER_103 = 103,
  NUMBER_105 = 105,
}

export function RentBaitaiCodeFromJSON(json: any): RentBaitaiCode {
  return RentBaitaiCodeFromJSONTyped(json, false);
}

export function RentBaitaiCodeFromJSONTyped(
  json: any,
  ignoreDiscriminator: boolean
): RentBaitaiCode {
  return json as RentBaitaiCode;
}

export function RentBaitaiCodeToJSON(value?: RentBaitaiCode | null): any {
  return value as any;
}
