...
export interface FreeRent {
   ...
   * @memberof FreeRent
   */
  freeRentPeriodDatejun?: DateJun;
  /**
   *
   * @type {string}
   * @memberof FreeRent
   */
  freeRentCondition?: string;
}

export function FreeRentFromJSON(json: any): FreeRent {
  return FreeRentFromJSONTyped(json, false);
}

export function FreeRentFromJSONTyped(
  json: any,
  ...
  return {
    freeRentTerm: !exists(json, 'free_rent_term')
      ? undefined
      : json['free_rent_term'],
    freeRentPeriodDatejun: !exists(json, 'free_rent_period_datejun')
      ? undefined
      : DateJunFromJSON(json['free_rent_period_datejun']),
    freeRentCondition: !exists(json, 'free_rent_condition')
      ? undefined
      : json['free_rent_condition'],
  };
}

export function FreeRentToJSON(value?: FreeRent | null): any {
  if (value === undefined) {
    return undefined;
  }
  if (value === null) {
  ...
  return {
    free_rent_term: value.freeRentTerm,
    free_rent_period_datejun: DateJunToJSON(value.freeRentPeriodDatejun),
    free_rent_condition: value.freeRentCondition,
  };
}
