 ...
 * @export
 * @interface BusStopAccess
 */
export interface BusStopAccess {
  /**
   *
   * @type {number}
   * @memberof BusStopAccess
   */
  value?: number;
  /**
   *
   ...
   * @memberof BusStopAccess
   */
  ridingTime?: ValueWithUnit;
}

export function BusStopAccessFromJSON(json: any): BusStopAccess {
  return BusStopAccessFromJSONTyped(json, false);
}

export function BusStopAccessFromJSONTyped(
  json: any,
  ...
  return {
    ...
    busLineName: !exists(json, 'bus_line_name')
      ? undefined
      : json['bus_line_name'],
    busStopName: !exists(json, 'bus_stop_name')
      ? undefined
      : json['bus_stop_name'],
    ridingTime: !exists(json, 'riding_time')
      ? undefined
      : ValueWithUnitFromJSON(json['riding_time']),
  };
}

export function BusStopAccessToJSON(value?: BusStopAccess | null): any {
  if (value === undefined) {
    return undefined;
  }
  if (value === null) {
  ...
  return {
    value: value.value,
    unit: value.unit,
    bus_line_name: value.busLineName,
    bus_stop_name: value.busStopName,
    riding_time: ValueWithUnitToJSON(value.ridingTime),
  };
}
