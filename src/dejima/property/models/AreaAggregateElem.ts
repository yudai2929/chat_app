 ...
 * エリア別集計小計
 * @export
 * @interface AreaAggregateElem
 */
export interface AreaAggregateElem {
  /**
   * 物件数
   * @type {number}
   * @memberof AreaAggregateElem
   */
  count: number;
  /**
   * ドリルダウン用クエリパラメータ
...
export function AreaAggregateElemFromJSON(json: any): AreaAggregateElem {
  return AreaAggregateElemFromJSONTyped(json, false);
}

export function AreaAggregateElemFromJSONTyped(
  json: any,
...
export function AreaAggregateElemToJSON(value?: AreaAggregateElem | null): any {
  if (value === undefined) {
    return undefined;
  }
  if (value === null) {
