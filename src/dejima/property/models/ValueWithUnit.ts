...
export function ValueWithUnitFromJSON(json: any): ValueWithUnit {
  return ValueWithUnitFromJSONTyped(json, false);
}

export function ValueWithUnitFromJSONTyped(
  json: any,
...
export function ValueWithUnitToJSON(value?: ValueWithUnit | null): any {
  if (value === undefined) {
    return undefined;
  }
  if (value === null) {
