 ...
 * 住戸屋外設備
 * @export
 * @interface DwellingUnitOuterFacility
 */
export interface DwellingUnitOuterFacility {
  /**
   *
   * @type {string}
   * @memberof DwellingUnitOuterFacility
   */
  readonly outerFacilityCategory?: string;
  /**
   * 1: ベランダ<br/>2: バルコニー<br/>3: ルーフバルコニー<br/>4: 専用庭<br/>5: テラス<br/>6: 屋上テラス<br/>7: ウッドテラス<br/>8: 庭
   * @type {number}
   * @memberof DwellingUnitOuterFacility
   */
  outerFacilityCategoryCode?: number;
  /**
   *
   * @type {number}
   * @memberof DwellingUnitOuterFacility
...
export function DwellingUnitOuterFacilityFromJSON(
  json: any
): DwellingUnitOuterFacility {
  return DwellingUnitOuterFacilityFromJSONTyped(json, false);
}

export function DwellingUnitOuterFacilityFromJSONTyped(
  json: any,
  ...
  return {
    outerFacilityCategory: !exists(json, 'outer_facility_category')
      ? undefined
      : json['outer_facility_category'],
    outerFacilityCategoryCode: !exists(json, 'outer_facility_category_code')
      ? undefined
      : json['outer_facility_category_code'],
    outerArea: !exists(json, 'outer_area') ? undefined : json['outer_area'],
  };
}

export function DwellingUnitOuterFacilityToJSON(
  value?: DwellingUnitOuterFacility | null
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    outer_facility_category_code: value.outerFacilityCategoryCode,
    outer_area: value.outerArea,
  };
}
