...
import {
  ...
  DwellingUnitFeature,
  DwellingUnitFeatureFromJSON,
  DwellingUnitFeatureFromJSONTyped,
  DwellingUnitFeatureToJSON,
  DwellingUnitOuterFacility,
  DwellingUnitOuterFacilityFromJSON,
  DwellingUnitOuterFacilityFromJSONTyped,
  DwellingUnitOuterFacilityToJSON,
  Room,
  RoomFromJSON,
  RoomFromJSONTyped,
  RoomToJSON,
...
export interface DwellingUnit {
  ...
  /**
   *
   * @type {Array<DwellingUnitFeature>}
   * @memberof DwellingUnit
   */
  dwellingUnitFeature?: Array<DwellingUnitFeature>;
  /**
   *
   * @type {Array<DwellingUnitOuterFacility>}
   * @memberof DwellingUnit
   */
  dwellingUnitOuterFacility?: Array<DwellingUnitOuterFacility>;
  /**
   *
   * @type {Array<Room>}
   * @memberof DwellingUnit
...
export function DwellingUnitFromJSON(json: any): DwellingUnit {
  return DwellingUnitFromJSONTyped(json, false);
}

export function DwellingUnitFromJSONTyped(
  json: any,
  ...
  return {
    ...
    dwellingUnitFeature: !exists(json, 'dwelling_unit_feature')
      ? undefined
      : (json['dwelling_unit_feature'] as Array<any>).map(
          DwellingUnitFeatureFromJSON
        ),
    dwellingUnitOuterFacility: !exists(json, 'dwelling_unit_outer_facility')
      ? undefined
      : (json['dwelling_unit_outer_facility'] as Array<any>).map(
          DwellingUnitOuterFacilityFromJSON
        ),
    room: !exists(json, 'room')
      ? undefined
      : (json['room'] as Array<any>).map(RoomFromJSON),
  };
}

export function DwellingUnitToJSON(value?: DwellingUnit | null): any {
  if (value === undefined) {
    return undefined;
  }
  if (value === null) {
  ...
  return {
    ...
    dwelling_unit_feature:
      value.dwellingUnitFeature === undefined
        ? undefined
        : (value.dwellingUnitFeature as Array<any>).map(
            DwellingUnitFeatureToJSON
          ),
    dwelling_unit_outer_facility:
      value.dwellingUnitOuterFacility === undefined
        ? undefined
        : (value.dwellingUnitOuterFacility as Array<any>).map(
            DwellingUnitOuterFacilityToJSON
          ),
    room:
      value.room === undefined
        ? undefined
        : (value.room as Array<any>).map(RoomToJSON),
  };
}
