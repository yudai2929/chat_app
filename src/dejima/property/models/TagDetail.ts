...
export function TagDetailFromJSON(json: any): TagDetail {
  return TagDetailFromJSONTyped(json, false);
}

export function TagDetailFromJSONTyped(
  json: any,
  ...
  return {
    ...
    tagGroupName: !exists(json, 'tag_group_name')
      ? undefined
      : json['tag_group_name'],
  };
}

export function TagDetailToJSON(value?: TagDetail | null): any {
  if (value === undefined) {
    return undefined;
  }
  if (value === null) {
  ...
  return {
    tag_guid: value.tagGuid,
    tag_name: value.tagName,
    color: value.color,
    tag_group_name: value.tagGroupName,
  };
}
