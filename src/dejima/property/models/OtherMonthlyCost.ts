 ...
 * その他月次費用
 * @export
 * @interface OtherMonthlyCost
 */
export interface OtherMonthlyCost {
  /**
   * その他月次費用金額
   * @type {Price}
   * @memberof OtherMonthlyCost
   */
  otherMonthlyCost: Price;
  /**
   *
   * @type {string}
   * @memberof OtherMonthlyCost
...
export function OtherMonthlyCostFromJSON(json: any): OtherMonthlyCost {
  return OtherMonthlyCostFromJSONTyped(json, false);
}

export function OtherMonthlyCostFromJSONTyped(
  json: any,
  ...
  return {
    otherMonthlyCost: PriceFromJSON(json['other_monthly_cost']),
    otherMonthlyCostItem: json['other_monthly_cost_item'],
  };
}

export function OtherMonthlyCostToJSON(value?: OtherMonthlyCost | null): any {
  if (value === undefined) {
    return undefined;
  }
  if (value === null) {
  ...
  return {
    other_monthly_cost: PriceToJSON(value.otherMonthlyCost),
    other_monthly_cost_item: value.otherMonthlyCostItem,
  };
}
