 ...
 * @enum {string}
 */
export enum SaleBaitaiCode {
  NUMBER_209 = 209,
}

export function SaleBaitaiCodeFromJSON(json: any): SaleBaitaiCode {
  return SaleBaitaiCodeFromJSONTyped(json, false);
}

export function SaleBaitaiCodeFromJSONTyped(
  json: any,
  ignoreDiscriminator: boolean
): SaleBaitaiCode {
  return json as SaleBaitaiCode;
}

export function SaleBaitaiCodeToJSON(value?: SaleBaitaiCode | null): any {
  return value as any;
}
