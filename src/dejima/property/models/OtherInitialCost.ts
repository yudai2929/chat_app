...
import { Price, PriceFromJSON, PriceFromJSONTyped, PriceToJSON } from './';

/**
 * その他初期費用
 * @export
 * @interface OtherInitialCost
 */
export interface OtherInitialCost {
  /**
   * その他初期費用金額
   * @type {Price}
   * @memberof OtherInitialCost
   */
  otherInitialCost: Price;
  /**
   *
   * @type {string}
   * @memberof OtherInitialCost
   ...
   * @memberof OtherInitialCost
   */
  otherInitialCostComment?: string;
}

export function OtherInitialCostFromJSON(json: any): OtherInitialCost {
  return OtherInitialCostFromJSONTyped(json, false);
}

export function OtherInitialCostFromJSONTyped(
  json: any,
  ...
  return {
    otherInitialCost: PriceFromJSON(json['other_initial_cost']),
    otherInitialCostItem: json['other_initial_cost_item'],
    otherInitialCostComment: !exists(json, 'other_initial_cost_comment')
      ? undefined
      : json['other_initial_cost_comment'],
  };
}

export function OtherInitialCostToJSON(value?: OtherInitialCost | null): any {
  if (value === undefined) {
    return undefined;
  }
  if (value === null) {
  ...
  return {
    other_initial_cost: PriceToJSON(value.otherInitialCost),
    other_initial_cost_item: value.otherInitialCostItem,
    other_initial_cost_comment: value.otherInitialCostComment,
  };
}
