...
export interface RentPeriod {
   ...
   * @memberof RentPeriod
   */
  contractTerm?: ValueWithUnit;
  /**
   * 契約期日
   * @type {DateJun}
   * @memberof RentPeriod
   */
  contractEndDatejun?: DateJun;
}

export function RentPeriodFromJSON(json: any): RentPeriod {
  return RentPeriodFromJSONTyped(json, false);
}

export function RentPeriodFromJSONTyped(
  json: any,
  ...
  return {
    ...
    contractTerm: !exists(json, 'contract_term')
      ? undefined
      : ValueWithUnitFromJSON(json['contract_term']),
    contractEndDatejun: !exists(json, 'contract_end_datejun')
      ? undefined
      : DateJunFromJSON(json['contract_end_datejun']),
  };
}

export function RentPeriodToJSON(value?: RentPeriod | null): any {
  if (value === undefined) {
    return undefined;
  }
  if (value === null) {
  ...
  return {
    ...
    contract_term: ValueWithUnitToJSON(value.contractTerm),
    contract_end_datejun: DateJunToJSON(value.contractEndDatejun),
  };
}
