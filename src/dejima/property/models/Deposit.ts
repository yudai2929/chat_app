...
export interface Deposit {
   ...
   * @memberof Deposit
   */
  additionalDeposit?: PriceWithUnit;
  /**
   *
   * @type {string}
   * @memberof Deposit
   */
  additionalDepositReason?: string;
}
...
export function DepositFromJSONTyped(
  ...
  return {
    ...
    additionalDeposit: !exists(json, 'additional_deposit')
      ? undefined
      : PriceWithUnitFromJSON(json['additional_deposit']),
    additionalDepositReason: !exists(json, 'additional_deposit_reason')
      ? undefined
      : json['additional_deposit_reason'],
  };
}
...
export function DepositToJSON(value?: Deposit | null): any {
  ...
  return {
    ...
    unit: value.unit,
    additional_deposit: PriceWithUnitToJSON(value.additionalDeposit),
    additional_deposit_reason: value.additionalDepositReason,
  };
}
