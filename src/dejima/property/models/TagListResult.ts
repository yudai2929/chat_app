...
export interface TagListResult {
  ...
  /**
   *
   * @type {Array<TagDetail>}
   * @memberof TagListResult
   */
  results: Array<TagDetail>;
}

export function TagListResultFromJSON(json: any): TagListResult {
  return TagListResultFromJSONTyped(json, false);
}

export function TagListResultFromJSONTyped(
  json: any,
  ...
  return {
    ...
    results: (json['results'] as Array<any>).map(TagDetailFromJSON),
  };
}

export function TagListResultToJSON(value?: TagListResult | null): any {
  if (value === undefined) {
    return undefined;
  }
  if (value === null) {
  ...
  return {
    ...
    results: (value.results as Array<any>).map(TagDetailToJSON),
  };
}
