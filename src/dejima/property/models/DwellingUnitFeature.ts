 ...
 * 住戸特徴
 * @export
 * @interface DwellingUnitFeature
 */
export interface DwellingUnitFeature {
  /**
   *
   * @type {string}
   * @memberof DwellingUnitFeature
   */
   ...
   * @memberof DwellingUnitFeature
   */
  featureName: Array<string>;
}

export function DwellingUnitFeatureFromJSON(json: any): DwellingUnitFeature {
  return DwellingUnitFeatureFromJSONTyped(json, false);
}

export function DwellingUnitFeatureFromJSONTyped(
  json: any,
...
export function DwellingUnitFeatureToJSON(
  value?: DwellingUnitFeature | null
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    feature_category_name: value.featureCategoryName,
