...
export function LineLevelFromJSON(json: any): LineLevel {
  return LineLevelFromJSONTyped(json, false);
}

export function LineLevelFromJSONTyped(
  json: any,
  ignoreDiscriminator: boolean
): LineLevel {
  return json as LineLevel;
}

export function LineLevelToJSON(value?: LineLevel | null): any {
  return value as any;
}
