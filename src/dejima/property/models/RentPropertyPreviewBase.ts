 ...
 * 賃貸物件概要
 * @export
 * @interface RentPropertyPreviewBase
 */
export interface RentPropertyPreviewBase {
  /**
   *
   * @type {string}
   * @memberof RentPropertyPreviewBase
   */
...
export function RentPropertyPreviewBaseFromJSON(
  json: any
): RentPropertyPreviewBase {
  return RentPropertyPreviewBaseFromJSONTyped(json, false);
}

export function RentPropertyPreviewBaseFromJSONTyped(
  json: any,
...
export function RentPropertyPreviewBaseToJSON(
  value?: RentPropertyPreviewBase | null
): any {
  if (value === undefined) {
    return undefined;
  }
