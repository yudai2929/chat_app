 ...
 * 計測方法付き面積
 * @export
 * @interface AreaWithMeasurementMethod
 */
export interface AreaWithMeasurementMethod {
  /**
   *
   * @type {number}
   * @memberof AreaWithMeasurementMethod
   */
  area: number;
  /**
   *
...
export function AreaWithMeasurementMethodFromJSON(
  json: any
): AreaWithMeasurementMethod {
  return AreaWithMeasurementMethodFromJSONTyped(json, false);
}

export function AreaWithMeasurementMethodFromJSONTyped(
  json: any,
...
export function AreaWithMeasurementMethodToJSON(
  value?: AreaWithMeasurementMethod | null
): any {
  if (value === undefined) {
    return undefined;
  }
