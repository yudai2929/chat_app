...
export function DateJunFromJSON(json: any): DateJun {
  return DateJunFromJSONTyped(json, false);
}

export function DateJunFromJSONTyped(
  json: any,
  ...
  return {
    ...
    jun: !exists(json, 'jun') ? undefined : json['jun'],
    day: !exists(json, 'day') ? undefined : json['day'],
    text: !exists(json, 'text') ? undefined : json['text'],
  };
}

export function DateJunToJSON(value?: DateJun | null): any {
  if (value === undefined) {
    return undefined;
  }
  if (value === null) {
