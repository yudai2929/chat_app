 ...
 * 特優賃
 * @export
 * @interface Tokuyuchin
 */
export interface Tokuyuchin {
  /**
   *
   * @type {string}
   * @memberof Tokuyuchin
   */
  readonly tokuyuchinPriceChange?: string;
  /**
   * 1: 無<br/>2: 傾斜型<br/>3: フラット型
   * @type {number}
   * @memberof Tokuyuchin
   */
  tokuyuchinPriceChangeCode?: number;
  /**
   *
   * @type {number}
   * @memberof Tokuyuchin
   */
  tokuyuchinIncreaseRate?: number;
  /**
   *
   * @type {number}
   * @memberof Tokuyuchin
   */
  tokuyuchinSupportYears?: number;
  /**
   *
   * @type {string}
   * @memberof Tokuyuchin
   */
  tokuyuchinComment?: string;
  /**
   *
   * @type {number}
   * @memberof Tokuyuchin
   */
  tokuyuchinLowerCost?: number;
  /**
   *
   * @type {number}
   * @memberof Tokuyuchin
   */
  tokuyuchinUpperCost?: number;
}

export function TokuyuchinFromJSON(json: any): Tokuyuchin {
  return TokuyuchinFromJSONTyped(json, false);
}

export function TokuyuchinFromJSONTyped(
  json: any,
  ...
  return {
    tokuyuchinPriceChange: !exists(json, 'tokuyuchin_price_change')
      ? undefined
      : json['tokuyuchin_price_change'],
    tokuyuchinPriceChangeCode: !exists(json, 'tokuyuchin_price_change_code')
      ? undefined
      : json['tokuyuchin_price_change_code'],
    tokuyuchinIncreaseRate: !exists(json, 'tokuyuchin_increase_rate')
      ? undefined
      : json['tokuyuchin_increase_rate'],
    tokuyuchinSupportYears: !exists(json, 'tokuyuchin_support_years')
      ? undefined
      : json['tokuyuchin_support_years'],
    tokuyuchinComment: !exists(json, 'tokuyuchin_comment')
      ? undefined
      : json['tokuyuchin_comment'],
    tokuyuchinLowerCost: !exists(json, 'tokuyuchin_lower_cost')
      ? undefined
      : json['tokuyuchin_lower_cost'],
    tokuyuchinUpperCost: !exists(json, 'tokuyuchin_upper_cost')
      ? undefined
      : json['tokuyuchin_upper_cost'],
  };
}

export function TokuyuchinToJSON(value?: Tokuyuchin | null): any {
  if (value === undefined) {
    return undefined;
  }
  if (value === null) {
  ...
  return {
    tokuyuchin_price_change_code: value.tokuyuchinPriceChangeCode,
    tokuyuchin_increase_rate: value.tokuyuchinIncreaseRate,
    tokuyuchin_support_years: value.tokuyuchinSupportYears,
    tokuyuchin_comment: value.tokuyuchinComment,
    tokuyuchin_lower_cost: value.tokuyuchinLowerCost,
    tokuyuchin_upper_cost: value.tokuyuchinUpperCost,
  };
}
