...
import {
  RentPropertyPreview,
  RentPropertyPreviewFromJSON,
  RentPropertyPreviewFromJSONTyped,
  RentPropertyPreviewToJSON,
} from './';
...
export interface PropertyList {
  ...
  /**
   * 物件概要
   * @type {Array<RentPropertyPreview>}
   * @memberof PropertyList
   */
  results: Array<RentPropertyPreview>;
}
...
export function PropertyListFromJSONTyped(
  json: any,
  ...
  return {
    ...
    results: (json['results'] as Array<any>).map(RentPropertyPreviewFromJSON),
  };
}
...
export function PropertyListToJSON(value?: PropertyList | null): any {
  ...
  return {
    ...
    results: (value.results as Array<any>).map(RentPropertyPreviewToJSON),
  };
}
