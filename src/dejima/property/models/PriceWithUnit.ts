 ...
 * 単位付き金額・料金
 * @export
 * @interface PriceWithUnit
 */
export interface PriceWithUnit {
  /**
   *
   * @type {number}
   * @memberof PriceWithUnit
   */
  amount?: number;
  /**
   *
...
export function PriceWithUnitFromJSON(json: any): PriceWithUnit {
  return PriceWithUnitFromJSONTyped(json, false);
}

export function PriceWithUnitFromJSONTyped(
  json: any,
...
export function PriceWithUnitToJSON(value?: PriceWithUnit | null): any {
  if (value === undefined) {
    return undefined;
  }
  if (value === null) {
