 ...
 * 賃貸リフォーム情報
 * @export
 * @interface RentReform
 */
export interface RentReform {
  /**
   *
   * @type {string}
   * @memberof RentReform
   ...
   * @memberof RentReform
   */
  reformDatejun?: DateJun;
}

export function RentReformFromJSON(json: any): RentReform {
  return RentReformFromJSONTyped(json, false);
}

export function RentReformFromJSONTyped(
  json: any,
  ...
  return {
    reformDetail: !exists(json, 'reform_detail')
      ? undefined
      : json['reform_detail'],
    reformDatejun: !exists(json, 'reform_datejun')
      ? undefined
      : DateJunFromJSON(json['reform_datejun']),
  };
}

export function RentReformToJSON(value?: RentReform | null): any {
  if (value === undefined) {
    return undefined;
  }
  if (value === null) {
  ...
  return {
    reform_detail: value.reformDetail,
    reform_datejun: DateJunToJSON(value.reformDatejun),
  };
}
