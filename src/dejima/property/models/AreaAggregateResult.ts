...
import {
  AreaAggregateElem,
  AreaAggregateElemFromJSON,
  AreaAggregateElemFromJSONTyped,
  AreaAggregateElemToJSON,
} from './';

/**
 * エリア別集計結果
 * @export
 * @interface AreaAggregateResult
 */
export interface AreaAggregateResult {
  /**
   * 集計結果
   * @type {Array<AreaAggregateElem>}
   * @memberof AreaAggregateResult
   */
  results: Array<AreaAggregateElem>;
}

export function AreaAggregateResultFromJSON(json: any): AreaAggregateResult {
  return AreaAggregateResultFromJSONTyped(json, false);
}

export function AreaAggregateResultFromJSONTyped(
  json: any,
  ...
  return {
    results: (json['results'] as Array<any>).map(AreaAggregateElemFromJSON),
  };
}

export function AreaAggregateResultToJSON(
  value?: AreaAggregateResult | null
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    results: (value.results as Array<any>).map(AreaAggregateElemToJSON),
  };
}
