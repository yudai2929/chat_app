...
export function AreaLevelFromJSON(json: any): AreaLevel {
  return AreaLevelFromJSONTyped(json, false);
}

export function AreaLevelFromJSONTyped(
  json: any,
  ignoreDiscriminator: boolean
): AreaLevel {
  return json as AreaLevel;
}

export function AreaLevelToJSON(value?: AreaLevel | null): any {
  return value as any;
}
