...
export function BuildingFeatureFromJSON(json: any): BuildingFeature {
  return BuildingFeatureFromJSONTyped(json, false);
}

export function BuildingFeatureFromJSONTyped(
  json: any,
...
export function BuildingFeatureToJSON(value?: BuildingFeature | null): any {
  if (value === undefined) {
    return undefined;
  }
  if (value === null) {
