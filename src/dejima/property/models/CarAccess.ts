...
export function CarAccessFromJSON(json: any): CarAccess {
  return CarAccessFromJSONTyped(json, false);
}

export function CarAccessFromJSONTyped(
  json: any,
...
export function CarAccessToJSON(value?: CarAccess | null): any {
  if (value === undefined) {
    return undefined;
  }
  if (value === null) {
