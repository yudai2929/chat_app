...
export function InsuranceFromJSONTyped(
  json: any,
  ...
  return {
    insuranceMonth: !exists(json, 'insurance_month')
      ? undefined
      : json['insurance_month'],
    insuranceName: !exists(json, 'insurance_name')
      ? undefined
      : json['insurance_name'],
    insuranceComment: !exists(json, 'insurance_comment')
      ? undefined
      : json['insurance_comment'],
    insurancePrice: !exists(json, 'insurance_price')
      ? undefined
      : PriceFromJSON(json['insurance_price']),
  };
}
...
export function InsuranceToJSON(value?: Insurance | null): any {
  ...
  return {
    insurance_month: value.insuranceMonth,
    insurance_name: value.insuranceName,
    insurance_comment: value.insuranceComment,
    insurance_price: PriceToJSON(value.insurancePrice),
  };
}
